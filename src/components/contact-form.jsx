...
export class ContactForm extends React.Component{
    ...
    render(){
        ...
        <div class="form-group">
            ...
            <input name="name" className="form-control" value={data.name} 
        ...
        <div class="form-group">
            ...
            <select  className="form-control" name="select" onChange={this.fieldChange}>
                ...
                <option value="2">{this.options[0].label}</option>
                <option value="3">{this.options[1].label}</option>
                <option value="4">{this.options[2].label}</option>
                <option value="5">{this.options[3].label}</option>
        ...
        <div class="form-group">
            <label className="form-label"> <input type="checkbox" name="terms" value= {data.terms} onChange={this.fieldChange}/> I agree to terms and conditions </label>
